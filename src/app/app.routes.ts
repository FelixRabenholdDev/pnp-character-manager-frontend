...
import { CharacterCreateWizard } from './features/characters/dnd5e/character-create-wizard/character-create-wizard';
...
export const routes: Routes = [
  ...
  { path: 'characters/new', component: CharacterCreateWizard, canActivate: [authGuard] },
